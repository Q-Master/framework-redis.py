...
"""Install script for framework-redis.py"""
...
NAME = 'asyncframework-redis'
PACKAGES = find_packages(exclude=['tests'])
DESCRIPTION = 'Async framework redis addon.'
URL = 'https://github.com/Q-Master/framework-redis.py'
...
"""
LINKS = """
    git+https://github.com/Q-Master/framework.py.git#egg=asyncframework
"""

VERSION = '0.1.0'


LONG_DESCRIPTION = """***asyncframework-redis*** - async framework redis addon
===
